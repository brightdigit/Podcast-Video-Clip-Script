...
yes | convert -gravity East -font "$FONT" -pointsize 52 label:"$SHOW_NAME" -pointsize 32 label:"episode $EPISODE_NO" -pointsize 68 label:"$EPISODE_NAME" -pointsize 64 label:"$GUEST_APPEND" -append ".temp/$SHOW_NAME.$EPISODE_NO.$EPISODE_NAME.text.16x9.png"
